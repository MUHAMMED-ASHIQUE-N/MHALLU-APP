...
const PaymentDashboard = () => {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gray-100 dark:bg-gray-900 p-8 transition-colors duration-300", children: _jsxs("div", { className: "max-w-6xl ml-20", children: [_jsx(PaymentTabs, { activeTab: activeTab, setActiveTab: setActiveTab }), _jsx("div", { className: "mt-3 mb-2 text-lg font-semibold px-1 text-gray-800 dark:text-gray-100", children: "LAST PAID :-" }), _jsx(PaidUserList, { users: usersPaid }), _jsx("div", { className: "mt-6 mb-2 text-lg font-semibold px-1 text-gray-800 dark:text-gray-100", children: "DETAILS :-" }), _jsx(StatGrid, {}), _jsx(StatisticsCard, {})] }) }));
};
